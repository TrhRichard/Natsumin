...
from internal.functions import frmt_iter, badge_autocomplete, rep_autocomplete
...
# TODO: Figure out how to split groups into multiple files so this file doesnt become gigantic


class DatabaseExt(NatsuCog, name="Database"):
	...
	database_group = discord.commands.SlashCommandGroup("database", description="Various database related commands", guild_ids=GUILD_IDS)
